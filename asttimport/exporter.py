...
class Exporter:
    ...
    def build(self):
        full_year = TermsDefinition(id="TERM_FULL", terms="11", name="Egész év", short="YR")
        first_term = TermsDefinition(id="TERM_FIRST", terms="10", name="Első félév", short="F1")
        second_term = TermsDefinition(id="TERM_SECOND", terms="01", name="Második félév", short="F2")
        ...
        days_definitions = [
            DaysDefinition(id="D_X", days="10000,01000,00100,00010,00001", name="Bármely nap", short="X"),
            ...
            DaysDefinition(id="D_11N", days="10000,01000,00010,00001", name="11. normál nap", short="11-N"),
            DaysDefinition(id="D_12N", days="10000,01000,00100,00001", name="12. normál nap", short="12-N"),
        ]
        ...
        subjects = [
            Subject(id=subject.id, name=subject.name, short=subject.name, timeoff=subject.timeslots)
        ...
        for assignment in self.assignments:
            ...
            if assignment.double_count or assignment.active_day_count:
                normal_count = assignment.weekly_count - (assignment.double_count * 2) - assignment.active_day_count
                if normal_count:
